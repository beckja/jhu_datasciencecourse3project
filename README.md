...
- CodeBook.md: Description of variables in final data set and description of derivation
- run_analysis.R: R script to process input data and generate final tidy data set
- tidy_summary.txt: space-separated text file containing final tidy data set
